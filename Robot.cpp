...
void Robot::storePosition(double inputX, double inputY, double inputTheta,
                          double inputVX, double inputVY, double inputVTheta) {
  tempX = inputX;
  tempY = inputY;
...
double Robot::accessX() { return x; }

//-- Access to Y Cordinate of Robot
double Robot::accessY() { return y; }

//-- Access to Rotation of Robot
double Robot::accessTheta() { return theta; }

//-- Access to Movement Speed (X Vector)
double Robot::accessVX() { return vX; }

//-- Access to Movement Speed (Y Vector)
double Robot::accessVY() { return vY; }

//-- Access to Rotation Speed
double Robot::accessVTheta() { return vTheta; }
...
//-- Reset Check Value
void Robot::resetCheck() { checkValue = 0; }

//-- Output Error
string Robot::error() { return errorInfo; }
...
void Robot::setX(double input) { x = input; }

//-- Robot Y Value Implementor
void Robot::setY(double input) { y = input; }

//-- Robot Theta Value Implementor
void Robot::setTheta(double input) { theta = input; }
